...
const SectionTestimonials: FC = () => {
  const [showDetails, setShowDetails] = useState(false);

  return (
    <section className="relative isolate overflow-hidden bg-white px-1 sm:px-6 py-4 lg:pt-20 sm:py-8 lg:px-8 dark:bg-gray-900 ">
      ...
      <div className="mx-auto max-sm:my-16 max-w-2xl lg:max-w-4xl flex flex-col justify-center items-center">
        ...
        <p className="text-2xl 2xl:text-4xl sm:leading-[3rem] mt-5 max-sm:font-bold font-semibold text-center">
