...
import PostCardSaveAction from "@/ui/PostCardSaveAction/PostCardSaveAction";
import { PostDataType } from "@/data/types";
import PostCardLikeAndComment from "@/ui/PostCardLikeAndComment/PostCardLikeAndComment";
import CategoryBadgeList from "@/ui/CategoryBadgeList/CategoryBadgeList";
import PostTypeFeaturedIcon from "@/ui/PostTypeFeaturedIcon/PostTypeFeaturedIcon";
    ...
    <div className={`nc-Card2 group relative flex flex-col ${className}`}>
      <div className="block flex-shrink-0 flex-grow relative w-full h-0 pt-[75%] sm:pt-[55%] z-0">
        {/* <Image
          ...
          src={
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTcfrwCRKi_HbiPSF6pqeQODPZBotBpbGwQug&usqp=CAU"
          }
          alt={title}
        /> */}
